...
$pass = $row['password'];
if ($currentpass != $pass) {
	$error = "<center><h4><font color='#FF0000'>Incorrect Current Password!</h4></center></font><br>";
...
$error = "<center><h4><font color='green'>Password successfully changed!</h4></center></font><br>";
include ("change_pass.php");
}
else {
	$error = "<center><h4><font color='#FF0000'>New Password and Confirm Password does not match!</h4></center></font><br>";
	include ("change_pass.php");
}
}
else {
	$error = "<center><h4><font color='#FF0000'>Error!</h4></center></font><br>";
	include ("change_pass.php");
}
?>